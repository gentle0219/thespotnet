...
==== Sign In(from app's account)
    ...
    results:
      {"success":{"id":"53a911233366390002000000","name":"","email":"tester1@email.com","auth_token":"Czvz82bxs6qUzkxzzaye","role":"cleaner"}}
...
==== Get inventory requests
    ...
    Parameters: 
      auth_token,     String
    Results
      {"success":[{id, ivt_id, quantity, state}]}
...
==== Get unread message list    
    ...
    Parameters:
      auth_token,       String
    Results:
      {success: {id, sender_id, sender_name, sender_role, body}}
