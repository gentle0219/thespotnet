  ...
  def create_session
    ...
    if resource.nil?
      ...
      if resource.valid_password?( password )
        ...
        user_info={id:resource.id.to_s, name:resource.name,email:resource.email,auth_token:resource.authentication_token, role:resouce.get_role_of_number, messages:messages}
